...
return [
    ...
    | classe de validador. Algumas dessas regras têm várias versões, como as regras de
    ...
    */
    ...
    'contains' => 'O campo :attribute está faltando um valor exigido.',
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui você pode definir suas próprias mensagens de erro de validação para atributos
    | usando o formato "attribute.rule" para nomear as linhas. Isso facilita a
    | personalização da mensagem de erro para um atributo específico de uma regra.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de Linguagem de Atributos
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar os nomes dos atributos de
    | forma amigável. Isso apenas facilita o usuário final, ao invés de exibir o nome
    | real do campo do formulário.
    |
    */
